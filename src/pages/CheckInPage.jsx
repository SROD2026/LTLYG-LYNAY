...
export default function CheckInPage({
  ...
  return (
    <div
      className="container checkinPage"
      style={{
        "--page-bg": "#f3c9a8",
  ...
  className="appShell"
  style={{
    animation: "checkinSunsetDrift 18s ease-in-out infinite",
    width: "fit-content",
    margin: "0 auto",
  }}
>
...
<div className="panel" style={{  width: "fit-content", margin: "0 auto" }}>
